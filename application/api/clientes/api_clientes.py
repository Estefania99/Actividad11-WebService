...
# http://localhost:8080/api_clientes?user_hash=12345&action=put&id_cliente=1&nombre=nuevo&dapellido_paterno=nueva&apellido_materno=nuevo&telefono=nuevo&email=nuevo
...
# http://localhost:8080/api_clientes?user_hash=12345&action=update&id_cliente=1&nombre=nuevo&dapellido_paterno=nueva&apellido_materno=nuevo&telefono=nuevo&email=nuevo
